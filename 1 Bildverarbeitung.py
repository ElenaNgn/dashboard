...
def process_images_streamlit(uploaded_files, use_network_paths=False, 
    ...
    try:
        ...
        # SCHRITT 4 (bzw. 3 wenn S-Drive übersprungen): Excel erstellen
...
with st.sidebar:
    ...
    # S-Laufwerk Option - immer sichtbar
    copy_to_s_drive = st.checkbox(
        "📋 Dateien ins S-Laufwerk kopieren",
        value=True,
        key="copy_to_s_drive_checkbox",
        help="Kopiert alle verarbeiteten Dateien automatisch ins S:/Multimedia Laufwerk (nur im Netzwerk-Modus aktiv)"
    )
